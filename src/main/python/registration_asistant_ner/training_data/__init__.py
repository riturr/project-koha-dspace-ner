...
VALID_ENTITIES = ['authors', 'advisors']
...
def generate_training_data_files(
    ...
    if os.path.exists(training_files_path / "loaded_data.pkl"):
        ...
        raw_data: DataFrame = load_scraped_data(index_file, files_path, tessdata=tessdata, **kwargs)
...
if __name__ == '__main__':
    ...
    parser.add_argument('tessdata', type=str, help="Path to the tessdata directory for Tesseract.")
